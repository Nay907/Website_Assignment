...
let handler = new APIHandler("https://65a8ca61219bfa37186795d0.mockapi.io/apie");
...
let populateTable = async () => {
    ...
    response.forEach((item) => {
        ...
        tr.innerHTML = `<td>${item.id}</td><td>${item.name}</td><td>${item.createdAt}</td>
